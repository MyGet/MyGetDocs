...
When requested, the [MyGet Enterprise plan](https://www.myget.org/enterprise) provides support for Azure Active Directory to log in. This document describes the required configuration steps on your Azure Active Directory tenant. Note that Azure Active Directory B2C is not currently supported.
...
1. **Add a new application**
	...
	<img src="Images/Azure-AD/step1.png" title="Add an application my organization is developing" border="1" style="border: 1px solid black; width: 75%;" /><br />
...
2. **Give the application a name**
	...
	<img src="Images/Azure-AD/step2.png" title="Tell us about your application" border="1" style="border: 1px solid black; width: 75%;" /><br />
...
3. **Enter the application properties**
	...
	<img src="Images/Azure-AD/step3.png" title="App properties" border="1" style="border: 1px solid black; width: 75%;" /><br />
...
4. **Provide us with the Federation Metadata Document URL**
	...
	<img src="Images/Azure-AD/step4.png" title="Federation Metadata Document URL" border="1" style="border: 1px solid black; width: 75%;" /><br />
